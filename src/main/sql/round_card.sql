CREATE TABLE round_card (
  ...
  CONSTRAINT PK_round_card PRIMARY KEY (poker_table_id, round_id, card_type, sequence),
  CONSTRAINT FK_round_card_poker_table_round FOREIGN KEY (poker_table_id, round_id)
    REFERENCES poker_table_round(poker_table_id, round_id),
  CONSTRAINT round_card_sequence
